...
function ReportText( {reportData , setReportData ,setConfirmedReport}) {
  return (
      <>
...
<div>
   <div className="w-full mb-4 my-2 border border-gray-600 rounded-lg ">
       <div className="px-4 py-2  rounded-t-lg ">
           ...
           <textarea value={reportData || ""} onChange={(e) => setReportData(e.target.value)} id="comment" rows="15" className="w-full px-0  outline-none font-semibold font-systemf text-lg  text-gray-200  border-0 focus:ring-0  bg-transparent" placeholder="Report..." required ></textarea>
       </div>
