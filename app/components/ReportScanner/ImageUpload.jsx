...
function ImageUpload({setBase64Data , setAlert}) {
  ...
  return (
    ...
    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-30 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer   hover:bg-gray-200 ">
        {file ? <   Rr src={file} width={200} height={200} alt="image"/>   : <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">SVG, PNG, JPG , GIF or PDF </p>
        </div>}
